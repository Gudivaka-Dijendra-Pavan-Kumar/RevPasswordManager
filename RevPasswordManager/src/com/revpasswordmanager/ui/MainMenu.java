        ...
        while (true) {
            try {
                ...
                if (userId < 0) {
                	...
                	System.out.println("--------REVPASSWORD MANAGER--------");
                   ...
                   ========================= */
                    ...
                    switch (ch) {
                        ...
                        case 5:
                            ...
                            String newAccPwd = sc.nextLine();

                            boolean updated = passwordService.update(userId, updateAcc, newAccPwd);
                            System.out.println(updated ? "Password updated successfully"
                                                       : "Account not found");
                            break;
                        case 6:
                            System.out.print("Enter Account Name: ");
                            ...
                            boolean deleted = passwordService.delete(userId, deleteAcc);
                            System.out.println(deleted ? "Password deleted successfully"
                                                       : "Account not found");
                            break;
